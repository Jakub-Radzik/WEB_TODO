...
import { GET_GOOGLE_AUTH_URL, GoogleAuthUrlResponse, GoogleAuthUrlVariables } from "../graphQL/queries/google";
...
export const GoogleButton = () => {
    ...
    return <StyledButton2 style={{fontSize: 20}} onClick={onClickHandler}>
        <p style={{marginRight:10}}>Continue with: </p> <img src={GoogleIcon} style={{
            width: 30,
            height: 30,
        }}/>
    </StyledButton2>
